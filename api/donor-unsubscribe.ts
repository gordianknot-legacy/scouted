          ...
          <tr>
            <td style="padding:36px 32px; text-align:center;">
              ...
              <p style="margin:0 0 24px; font-family:Cambria,Georgia,serif; font-size:15px; color:#666; line-height:1.7;">
                You've been removed from ScoutEd donor newsletters. You won't receive any more newsletter emails from us.
              </p>
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  // Delete donor by unsubscribe_token
  const deleteRes = await fetch(
    `${SUPABASE_URL}/rest/v1/donors?unsubscribe_token=eq.${token}`, {
    method: 'DELETE',
    headers: {
